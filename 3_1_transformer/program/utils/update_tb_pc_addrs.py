...
PC_SYMBOL_MAP: List[Tuple[str, str]] = [
    ("PC_MAIN", "main"),
    ("PC_LAYER_NORM", "layer_norm_q12.constprop.0"),
    ("PC_MULTI_HEAD_ATTENTION", "multi_head_attention"),
...
def main() -> int:
    ...
    if missing:
        print("[WARN] Missing symbols in disassembly (skipping):", ", ".join(missing), file=sys.stderr)
